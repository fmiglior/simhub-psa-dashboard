...
#include <avr/pgmspace.h>
#include <Wire.h>
#include <mcp2515.h> //mcp2515 lib
#include "can.h" //can ids
...
#define DEVICE_UNIQUE_ID "8daf58fb-a990-4f20-9fd8-8b6d2ddc6ed0" //{"UniqueId":"8daf58fb-a990-4f20-9fd8-8b6d2ddc6ed0","Name":"DEVICE_UNIQUE_ID","Type":"uniqueid"}
...
// -------------------------------------------------------------------------------------------------------
#define I2CLCD_enabled 0   //{"Group":"20x4 I2C LCD","Name":"I2CLCD_enabled","Title":"I2C LCD (2004) enabled\r\nUno, Ethernet, Nano : A4(SDA), A5(SCL)\r\nMega2560 : 20 (SDA), 21 (SCL)\r\nLeonardo : 2 (SDA), 3 (SCL)\r\nDue : 20 (SDA), 21 (SCL), SDA1, SCL1","DefaultValue":"0","Type":"bool","Pins":"nano:18,I2C LCD SDA;19,I2C LCD SCL|uno:18,I2C LCD SDA;19,I2C LCD SCL|mega:20,I2C LCD SDA;21,I2C LCD SCL"}
...
#include "SHRGBLedsNeoPixel.h"
	...
	if (WS2812B_MATRIX_ENABLED > 0) {
		shRGBMatrixWS2812B.begin(64, false, WS2812B_MATRIX_SERPENTINELAYOUT, false);
